Algoritmo Ejercicio_1_Vectores
	Escribir "Programa el cual al usuario se le pide 20 numeros y calcula la media";
	Escribir "=================================================";
	...
	Dimension nota[20];
	suma<-0;
	Para num<-1 Hasta 20-1  Hacer			//este bucle servira para que nos de la nota media 
		leer nota[num];
		suma<-suma+nota[num];
	FinPara
	media<- suma/20;
